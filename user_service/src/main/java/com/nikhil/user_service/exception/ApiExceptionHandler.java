package com.nikhil.user_service.exception;
...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> duplicateKey(DuplicateKeyException e) {
        log.warn("Duplicate key: {}", e.getMessage());
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(Map.of("message", e.getMessage() != null ? e.getMessage() : "Email already in use."));
    }
